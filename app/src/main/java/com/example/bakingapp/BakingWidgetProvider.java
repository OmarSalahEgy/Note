...
public class BakingWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.tv_widget_title, sharedPreferences.getString(NetworkUtils.PREFERENCES_WIDGET_TITLE, ""));
        views.setTextViewText(R.id.tv_widget_ingredients, sharedPreferences.getString(NetworkUtils.PREFERENCES_WIDGET_CONTENT, ""));
